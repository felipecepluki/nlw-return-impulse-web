...
export function FeedbackSucessStep({
  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center py-10 w-[304px] bg-white dark:bg-zinc-900 ">
        <svg
          width="37"
          height="36"
          viewBox="0 0 37 36"
        ...
        <button
          ...
          className="py-2 px-6 mt-6 bg-zinc-100 dark:bg-zinc-800 rounded-md border-transparent text-sm text-zinc-800 dark:text-zinc-100 leading-6 hover:bg-zinc-200 dark:hover:bg-zinc-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500 transition-colors disabled:opacity-50 disabled:hover:bg-brand-500"
        >
          Quero enviar outro
        </button>
      </div>
